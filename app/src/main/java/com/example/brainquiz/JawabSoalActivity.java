...
public class JawabSoalActivity extends AppCompatActivity {
    ...
    private void submitJawaban() {
        ...
        apiService.submitJawaban("Bearer " + token, jawabanList).enqueue(new Callback<JawabanResponse>() {
            @Override
    ...
    private void showResultDialog(JawabanResponse response) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("OK", (dialog, which) -> {
                    ...
                    Intent intent = new Intent(JawabSoalActivity.this, HomeActivity.class);
