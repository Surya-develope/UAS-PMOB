...
public class TingkatanActivity extends AppCompatActivity {
    ...
    private Button btnTambahTingkatan, btnDebugTingkatan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDebugTingkatan = findViewById(R.id.btnDebugTingkatan);
        ...
        // Set click listener for "Debug API" button
        btnDebugTingkatan.setOnClickListener(v -> {
            Intent intent = new Intent(TingkatanActivity.this, TestTingkatanActivity.class);
            startActivity(intent);
        });
