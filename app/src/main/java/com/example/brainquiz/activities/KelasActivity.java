...
public class KelasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTambahKelas.setOnClickListener(v -> {
            Intent intent = new Intent(KelasActivity.this, com.example.brainquiz.activities.TambahKelasActivity.class);
            ...
            menuIcon.setOnClickListener(view -> {
                ...
                if (itemEdit != null) {
                    itemEdit.setOnClickListener(v -> {
                        if (kelas.getId() != 0) {
                            Intent intent = new Intent(KelasActivity.this, com.example.brainquiz.activities.EditKelasActivity.class);
