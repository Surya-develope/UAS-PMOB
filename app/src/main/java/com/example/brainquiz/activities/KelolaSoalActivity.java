...
public class KelolaSoalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // JsonTestHelper.testProblematicResponse();
    }
    ...
    private void setupClickListeners() {
        btnTambahSoal.setOnClickListener(v -> {
            Intent intent = new Intent(this, com.example.brainquiz.activities.TambahSoalActivity.class);
    ...
    private void showSoalMenu(Soal soal, int position) {
        ...
        if (menuEdit != null) {
            menuEdit.setOnClickListener(v -> {
                Intent intent = new Intent(this, com.example.brainquiz.activities.EditSoalActivity.class);
    ...
    private void deleteSoal(int soalId) {
        ...
        apiService.deleteSoal(authManager.getAuthorizationHeader(), soalId).enqueue(new Callback<Void>() {
            @Override
