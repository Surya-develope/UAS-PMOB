...
public class PendidikanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTambahPendidikan.setOnClickListener(v -> {
            Intent intent = new Intent(PendidikanActivity.this, com.example.brainquiz.activities.TambahPendidikanActivity.class);
                ...
                if (itemEdit != null) {
                    itemEdit.setOnClickListener(v -> {
                        if (pendidikan.getId() != 0) {
                            Intent intent = new Intent(PendidikanActivity.this, com.example.brainquiz.activities.EditPendidikanActivity.class);
